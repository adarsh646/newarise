...
class StretchingWorkoutsPage extends StatelessWidget {
  const StretchingWorkoutsPage({super.key});

  @override
  Widget build(BuildContext context) {
    const String categoryName = "Stretching";
        ...
        builder: (context, snapshot) {
          if (snapshot.data == true) {
            return FloatingActionButton(
              ...
              tooltip: 'Add Stretching Workout',
